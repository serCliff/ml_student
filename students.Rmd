...
models = c(reg$method, rednnet$method, rf$method, gbm$method, xgbm$method)
accuracies = c(reg$results$Accuracy, nnettune$Accuracy, rftune$Accuracy, gbmtune$Accuracy, xgbmtune$Accuracy)
